...
function WARD:__init()
	...
	self:CreateMenu()	
	self.Packet = GetGameVersion():sub(1,4)=='6.17' and {
		['Header'] = 0x0154,
		['sourcePos'] = 96,
		['stringPos'] = 45,
...
function MISS:__init()
	...
	self.Packets = GetGameVersion():sub(1, 4) == '6.17' and {
		...
		['AggroUpdate'] = { ['Header'] = 0x00B3, ['pos'] = 2, },
		['Missile'] = { ['Header'] = 0x0086, ['pos'] = 2, },
		['JunglePos'] = {
...
function TIMERS:__init()
	...
	self.Packets = GetGameVersion():sub(1,4) == '6.17' and {
		...
		['Inhibitor'] = { ['Header'] = 0x0104, ['pos'] = 2, },  --pick the one that is size 19
		['SummonerRift'] = {
...
function OTHER:__init()
	...
	for i=1, heroManager.iCount do
		...
		if h.team == TEAM_ALLY and not h.isMe and h.charName == 'Thresh' then
			self.Packets = GetGameVersion():find('6.17.155.1085') and {
				['Header'] = 0x0007,
				['vTable'] = 0xE86E34,
...
function TRINKET:__init()
	...
	} or GetGameVersion():sub(1,4) == '6.17' and {
		['Header'] = 0x000C, ['pos'] = 13, ['ssID'] = 0x5151555A,
	}
