...
function WARD:__init()
	...
	self:CreateMenu()	
	self.Packet = GetGameVersion():sub(1,4)=='6.13' and {
		['Header'] = 0x0012,
		['sourcePos'] = 96,
		['stringPos'] = 45,
...
function MISS:__init()
	...
	self.Packets = GetGameVersion():sub(1, 4) == '6.13' and {
		['LoseVision'] = { ['Header'] = 0x00A3, ['pos'] = 2, },
		['GainVision'] = { ['Header'] = 0x00F7, ['pos'] = 2, },
		['Recall'] = { 
			['Header'] = 0x0048, 
			['pos'] = 80, 
			['stringPos'] = 6, 
		...
		['Reset'] = { ['Header'] = 0x00E4, ['pos'] = 2, ['pos2'] = 11, },
		['Aggro'] = { ['Header'] = 0X00BE, ['pos'] = 2, },
		['AggroUpdate'] = { ['Header'] = 0x0071, ['pos'] = 2, },
		['Missile'] = { ['Header'] = 0x014E, ['pos'] = 2, },
		['JunglePos'] = {
...
function TIMERS:__init()
	...
	self.Packets = GetGameVersion():sub(1,4) == '6.13' and {
		['Jungle'] = { ['Header'] = 0x001D, ['campPos'] = 16, ['idPos'] = 6, ['idZero'] = 0x3D3D3D3D, },
...
function OTHER:__init()
	...
	for i=1, heroManager.iCount do
		...
		if h.team == TEAM_ALLY and not h.isMe and h.charName == 'Thresh' then
			self.Packets = GetGameVersion():find('6.13.148.7588') and {
				['Header'] = 0x012A,
				['vTable'] = 0x102268C,
...
function TRINKET:__init()
	...
	} or GetGameVersion():sub(1,4) == '6.13' and {
		['Header'] = 0x00C0, ['pos'] = 13, ['ssID'] = 0x5151555A,
	}
