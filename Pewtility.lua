...
function WARD:__init()
	...
	self:CreateMenu()	
	self.Packet = GetGameVersion():sub(1,4)=='6.1.' and {
		['Header'] = 0x0083,
		['sourcePos'] = 95,
		['stringPos'] = 53,
...
function MISS:__init()
	...
	self.Packets = GetGameVersion():sub(1, 4) == '6.1.' and {
